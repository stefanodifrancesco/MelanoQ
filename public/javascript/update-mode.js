$(document).ready(function() {
    ...
    $("#fieldsetSectionBEval #selectQuestions").on("change", function(evt) {
        ...
        if ($(this).val() == "No" || $(this).val() == "Not choosed") {
            $(this).parents("#fieldsetSectionBEval").find(".show-control input[type=text]").prop("required", false).val("");
    ...
    $("#fieldsetActinicKeratoses #selectActinicKeratoses").on("change", function(evt) {
        ...
        if ($(this).val() != "Yes") {
            $(this).parents("#fieldsetActinicKeratoses").find(".show-control #selectActinicKeratosesSite").prop("required", false).val("");
            $(this).parents("#fieldsetActinicKeratoses").find(".show-control #selectActinicKeratosesDistribution").prop("required", false).val("");
    ...
    */
    ...
    $("#fieldsetPregnancy_History #Pregnant_Yes,#Pregnant_No").on("click", function(evt) {
        ...
        if ($(this).attr("id") == "Pregnant_No") {
            ...
            $("#fieldsetPregnancy_History .Pregnancy_Stats :input").prop("disabled", true).val("");
        }
    });
    ...
    $("#fieldsetPregnancy_History #Pregnancy_Before input").on("click", function(evt) {
        ...
        if ($(this).attr("id") == "Before_No") {
            ...
            $("#Pregnancy_Before").find(".show-transition :input").val("");
        }
    });
    ...
    $("#fieldsetPregnancy_History #Pregnancy_After input").on("click", function(evt) {
        ...
        if ($(this).attr("id") == "After_No") {
            ...
            $("#Pregnancy_After").find(".show-transition :input").val("");
        }
    });
    /*Fine Commit*/
    List_BCC_Sites = [];
    ...
    $("#submit").on('click', function(e) {
        ...
        delete_undefined(List_Family_History_3Degree);
...
function set_JSON_Tables(json_object) {
    ...
    if (json_object.melanoma_characteristics != undefined) {
...
function Initialize() {
    ...
    /*** 1st primary melanoma characteristics ***/
    ...
    $("[name='melanoma_characteristics[first_melanoma][SNL][presence]']").trigger('change');
    ...
    /*** 2nd primary melanoma characteristics ***/
    ...
    $("[name='melanoma_characteristics[second_melanoma][SNL][presence]']").trigger('change');
    ...
    /*** 3rd primary melanoma characteristics ***/
    ...
    $("[name='melanoma_characteristics[third_melanoma][SNL][presence]']").trigger('change');
